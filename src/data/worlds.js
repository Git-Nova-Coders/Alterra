...
export const WORLDS = {
  ...
  fantasy: {
    ...
    artifact: 'Heart of the Sylvan Root',
  ...
  mystery: {
    ...
    artifact: 'Chrono-Relic Monolith',
    artifactDescription: 'A gravimetric shard that vibrates inversely to real-world spacetime.',
